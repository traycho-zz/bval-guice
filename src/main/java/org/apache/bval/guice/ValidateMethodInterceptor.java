...
public final class ValidateMethodInterceptor implements MethodInterceptor {
    ...
    public Object invoke(MethodInvocation invocation) throws Throwable {
        ...
        ClassValidator methodValidator = validator.unwrap(ClassValidator.class);
        ...
        if (validate.validateReturnedValue()) {
            constraintViolations.addAll(methodValidator.validateReturnValue(clazz, method, returnedValue, groups));
